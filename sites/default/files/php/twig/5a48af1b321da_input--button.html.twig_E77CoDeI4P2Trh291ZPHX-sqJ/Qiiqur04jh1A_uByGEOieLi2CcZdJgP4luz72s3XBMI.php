...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/Applications/MAMP/htdocs/lori-drupal-8.4.3/themes/bootstrap/templates/input/input--button.html.twig");
    }
}
